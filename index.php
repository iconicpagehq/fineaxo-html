    ...
    <div class="container">
        ...
        <div class="reels-row scrollbar-hide">
            ...
            <!-- <div class="reel-card">
                ...
                <a href="https://www.instagram.com/rockfold_fitness_keshavnagar/" target="_blank" class="follow-cta"
            ...
            <!-- <div class="reel-card">
                ...
                <button class="play-btn" aria-label="Play video">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                        <path
                            d="M14.222 9.374c1.037-.61 1.037-2.137 0-2.748L11.528 5.04 8.32 8l3.207 2.96zm-3.595 2.116L7.583 8.68 1.03 14.73 c.201 1.029 1.36 1.61 2.303 1.055zM1 13.396V2.603L6.846 8zM1.03 1.27l6.553 6.05 3.044-2.81 L3.333.215C2.39-.341 1.231 .24 1.03 1.27" />
                    </svg>
                </button>
                <a href="https://www.instagram.com/rockfold_fitness_keshavnagar/" target="_blank" class="follow-cta"
                    rel="noopener noreferrer">
